            ...
            <tr>
                <td>
                    <div class="d-flex justify-content-between">
                        {{ $post->title ?? "Title's post belongs here" }}
                        <div class="d-flex align-items-center">
                            <input 
                                type="image" 
                                src="{{ asset('/assets/trash.svg') }}" 
                                class="btn-primary mx-1 control-buttons" 
                            />
                            <input 
                                type="image" 
                                src="{{ asset('/assets/view.svg') }}" 
                                class="btn-primary mx-2 control-buttons" 
                            />
                            <input 
                                type="image" 
                                src="{{ asset('/assets/setting.svg') }}" 
                                class="btn-primary mx-1 control-buttons" 
                            />
                        </div>
                    </div>
